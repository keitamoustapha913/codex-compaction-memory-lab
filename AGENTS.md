...
1. Before starting any task, read `.codex/memory/LIVE_MEMORY.md` if it exists.
2. Treat `.codex/memory/LIVE_MEMORY.md` as durable continuity memory.
3. Update `.codex/memory/LIVE_MEMORY.md` after every material discovery, file change, validation result, blocker, and phase transition.
